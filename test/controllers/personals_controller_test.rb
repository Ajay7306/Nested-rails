...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference("Personal.count") do
      post personals_url, params: { personal: { address: @personal.address, photo: @personal.photo, project_id: @personal.project_id } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { address: @personal.address, photo: @personal.photo, project_id: @personal.project_id } }
